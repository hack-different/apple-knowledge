# Commentary on bridgeOS/T2 Research

## The Mis-reporting

Numerous technical details are incorrect in the ironPeak article due to a lack of understanding all the components and their interaction.  Moreover while we appreciate Neils work, and the visibility he gave the issue, we think referring to him as “a security consultant analyzing the impact of checkra1n and the T2” is a better description.  Another problem is their use of the term “disclosure”.  The T2 team reported successful checkm8 against the T2 to product security, what Neils did was after reading coverage asked for a response from Apple.  Disclosure is a term received for a researcher speaking to a vendor, not a consumer asking for commentary.
[+Existing T2 Coverage](https://paper.dropbox.com/doc/Existing-T2-Coverage-n2ByvSgsY7EWACprZ1jBI) 
...
Mar 22, 2020 - rickmark creates first writeup and analysis of the T2 impact created and circulated in industry and on Reddit - https://paper.dropbox.com/pad-desktop-redirect?relativePadUrl=%2Fdoc%2FNOTES-Crouching-T2-Hidden-Danger--A9D8yBay8_W2AWSvNn3ifN9fAg-5Fv29pghexoM9jT3KV38m
...
Jul 24, 2020 - aunali1 completes PoC bridgeOS SDK and compiles a benchmarking utility which provides first speed test and specifications of the T2  - https://twitter.com/su_rickmark/status/1286886010681462784

Aug 9, 2020 - Yalu releases `blackbird` an un-patchable Secure Enclave Processor flaw similar to checkm8 - https://yalujailbreak.net/seprom-code-execution/
...
Sep 30, 2020 - Article above discussed in industry Slack instance (of which Neils is a member), rickmark solicits questions, and answers those and others in Slack - 
[+Industry: bridgeOS / checkra1n Questions](https://paper.dropbox.com/doc/Industry-bridgeOS-checkra1n-Questions-IuejF6oBFWiUtGhYkAz2z) 
...
Oct 5, 2020 - Corrections of accuracy compiled and sent to Neils - [https://paper.dropbox.com/pad-desktop-redirect?relativePadUrl=%2Fdoc%2FNOTES-Crouching-T2-Hidden-Danger--A9D8yBay8_W2AWSvNn3ifN9fAg-5Fv29pghexoM9jT3KV38m](https://paper.dropbox.com/doc/NOTES-Crouching-T2-Hidden-Danger-5Fv29pghexoM9jT3KV38m)
