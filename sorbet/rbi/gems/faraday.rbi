...
class Faraday::RequestOptions < Anonymous_Faraday_Options_7
  def []=(key, value); end
  def stream_response?; end
end
class Anonymous_Faraday_Options_8 < Faraday::Options
  def ca_file; end
  def ca_file=(_); end
  def ca_path; end
  def ca_path=(_); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_8
  def disable?; end
  def verify?; end
end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_9
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_10
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_11
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
...
class Faraday::Request < Anonymous_Struct_12
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
