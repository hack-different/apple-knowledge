...
module Psych
  def self.filename_and_options_from_arguments(arguments); end
  def self.load_file_with_options(file, options = nil); end
  def self.load_with_options(yaml, *original_arguments); end
  def self.options_for_safe_load(base_options); end
  def self.safe_mode_from_options(method, options = nil); end
end
