...
# source://sawyer-0.8.2/lib/sawyer.rb:1
module Sawyer; end

# source://sawyer-0.8.2/lib/sawyer/agent.rb:5
class Sawyer::Agent
  ...
  # @return [Boolean]
  #
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:137
  def allow_undefined_methods?; end
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:85
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:124
  ...
  # Returns a String.
  #
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:115
  def encode_body(data); end

  # source://sawyer-0.8.2/lib/sawyer/agent.rb:132
  def expand_url(url, options = T.unsafe(nil)); end

  # source://sawyer-0.8.2/lib/sawyer/agent.rb:141
  def inspect; end

  # Returns the value of attribute links_parser.
  #
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:8
  ...
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:150
  def marshal_dump; end

  # source://sawyer-0.8.2/lib/sawyer/agent.rb:154
  def marshal_load(dumped); end

  # source://sawyer-0.8.2/lib/sawyer/agent.rb:128
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:54
  def rels; end
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:61
  def root; end
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:68
  def start; end

  # private
  #
  # source://sawyer-0.8.2/lib/sawyer/agent.rb:146
  def to_yaml_properties; end

  class << self
    # source://sawyer-0.8.2/lib/sawyer/agent.rb:23
    def decode(data); end

    # source://sawyer-0.8.2/lib/sawyer/agent.rb:19
    def encode(data); end

    # source://sawyer-0.8.2/lib/sawyer/agent.rb:15
    def serializer; end
    ...
    #
    # source://sawyer-0.8.2/lib/sawyer/agent.rb:12
    def serializer=(_arg0); end
  end
end

# source://sawyer-0.8.2/lib/sawyer/agent.rb:6
Sawyer::Agent::NO_BODY = T.let(T.unsafe(nil), Set)

# source://sawyer-0.8.2/lib/sawyer.rb:4
class Sawyer::Error < ::StandardError; end

# source://sawyer-0.8.2/lib/sawyer/link_parsers/hal.rb:2
module Sawyer::LinkParsers; end

# source://sawyer-0.8.2/lib/sawyer/link_parsers/hal.rb:4
class Sawyer::LinkParsers::Hal
  # source://sawyer-0.8.2/lib/sawyer/link_parsers/hal.rb:6
  def parse(data); end
end

# source://sawyer-0.8.2/lib/sawyer/link_parsers/simple.rb:4
class Sawyer::LinkParsers::Simple
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/link_parsers/simple.rb:14
  def parse(data); end
end

# source://sawyer-0.8.2/lib/sawyer/link_parsers/simple.rb:6
Sawyer::LinkParsers::Simple::LINK_REGEX = T.let(T.unsafe(nil), Regexp)

# source://sawyer-0.8.2/lib/sawyer/relation.rb:2
class Sawyer::Relation
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:108
  def initialize(agent, name, href, method = T.unsafe(nil)); end

  # Returns the value of attribute agent.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:56
  def agent; end
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:259
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:221
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:161
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:144
  def head(options = T.unsafe(nil)); end

  # source://octokit-4.22.0/lib/ext/sawyer/relation.rb:4
  ...
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:268
  def inspect; end
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:236
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:206
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:176
  ...
  # Returns a Sawyer::Response.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:191
  ...
  class << self
    ...
    # Returns a Relation.
    #
    # source://sawyer-0.8.2/lib/sawyer/relation.rb:93
    ...
    #
    # source://sawyer-0.8.2/lib/sawyer/relation.rb:71
    def from_links(agent, index, rels = T.unsafe(nil)); end
  end
end

# source://sawyer-0.8.2/lib/sawyer/relation.rb:3
class Sawyer::Relation::Map
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:6
  def initialize; end
  ...
  # Returns nothing.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:15
  def <<(rel); end
  ...
  # Returns a Relation.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:24
  def [](key); end

  # source://sawyer-0.8.2/lib/sawyer/relation.rb:50
  def inspect; end
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:38
  def keys; end
  ...
  # Returns an Integer.
  #
  # source://sawyer-0.8.2/lib/sawyer/relation.rb:31
  def size; end

  # source://sawyer-0.8.2/lib/sawyer/relation.rb:42
  def to_h; end
...
# source://sawyer-0.8.2/lib/sawyer/resource.rb:2
class Sawyer::Resource
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/resource.rb:12
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/resource.rb:54
  def [](method); end
  ...
  # Returns - value
  #
  # source://sawyer-0.8.2/lib/sawyer/resource.rb:66
  def []=(method, value); end

  # Returns the value of attribute _agent.
  #
  # source://sawyer-0.8.2/lib/sawyer/resource.rb:4
  def _agent; end
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/resource.rb:5
  def attrs; end

  # source://sawyer-0.8.2/lib/sawyer/resource.rb:122
  def each(&block); end

  # source://sawyer-0.8.2/lib/sawyer/resource.rb:118
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://sawyer-0.8.2/lib/sawyer/resource.rb:45
  def key?(key); end

  # source://sawyer-0.8.2/lib/sawyer/resource.rb:146
  def marshal_dump; end

  # source://sawyer-0.8.2/lib/sawyer/resource.rb:150
  def marshal_load(dumped); end

  # Provides access to a resource's attributes.
  #
  # source://sawyer-0.8.2/lib/sawyer/resource.rb:76
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/resource.rb:32
  def process_value(value); end

  # source://sawyer-0.8.2/lib/sawyer/resource.rb:131
  def to_attrs; end
  ...
  # private
  #
  # source://sawyer-0.8.2/lib/sawyer/resource.rb:127
  def to_yaml_properties; end

  class << self
    # Wire up accessor methods to pull from attrs
    #
    # source://sawyer-0.8.2/lib/sawyer/resource.rb:100
    def attr_accessor(*attrs); end
  end
end

# source://sawyer-0.8.2/lib/sawyer/resource.rb:73
Sawyer::Resource::ATTR_PREDICATE = T.let(T.unsafe(nil), String)

# source://sawyer-0.8.2/lib/sawyer/resource.rb:72
Sawyer::Resource::ATTR_SETTER = T.let(T.unsafe(nil), String)

# source://sawyer-0.8.2/lib/sawyer/resource.rb:3
Sawyer::Resource::SPECIAL_METHODS = T.let(T.unsafe(nil), Set)

# source://sawyer-0.8.2/lib/sawyer/response.rb:2
class Sawyer::Response
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/response.rb:14
  def initialize(agent, res, options = T.unsafe(nil)); end

  # Returns the value of attribute agent.
  #
  # source://sawyer-0.8.2/lib/sawyer/response.rb:3
  def agent; end
  ...
  # source://sawyer-0.8.2/lib/sawyer/response.rb:25
  def data; end
  ...
  # source://sawyer-0.8.2/lib/sawyer/response.rb:68
  def inspect; end
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/response.rb:38
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/response.rb:50
  ...
  # source://sawyer-0.8.2/lib/sawyer/response.rb:64
  def time; end

  # source://sawyer-0.8.2/lib/sawyer/response.rb:60
  def timing; end
end

# source://sawyer-0.8.2/lib/sawyer/serializer.rb:5
class Sawyer::Serializer
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/serializer.rb:39
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/serializer.rb:62
  def decode(data); end

  # source://sawyer-0.8.2/lib/sawyer/serializer.rb:96
  def decode_hash(hash); end

  # source://sawyer-0.8.2/lib/sawyer/serializer.rb:103
  def decode_hash_value(key, value); end

  # source://sawyer-0.8.2/lib/sawyer/serializer.rb:88
  ...
  #
  # source://sawyer-0.8.2/lib/sawyer/serializer.rb:50
  def dump(data); end
  ...
  # source://sawyer-0.8.2/lib/sawyer/serializer.rb:77
  def encode_hash(hash); end

  # source://sawyer-0.8.2/lib/sawyer/serializer.rb:69
  ...
  # @return [Boolean]
  #
  # source://sawyer-0.8.2/lib/sawyer/serializer.rb:125
  def time_field?(key, value); end

  class << self
    # source://sawyer-0.8.2/lib/sawyer/serializer.rb:6
    def any_json; end

    # source://sawyer-0.8.2/lib/sawyer/serializer.rb:18
    def json; end

    # source://sawyer-0.8.2/lib/sawyer/serializer.rb:30
    def message_pack; end

    # source://sawyer-0.8.2/lib/sawyer/serializer.rb:24
    def multi_json; end

    # source://sawyer-0.8.2/lib/sawyer/serializer.rb:12
    def yajl; end
  end
end

# source://sawyer-0.8.2/lib/sawyer.rb:2
