...
# source://RUBY_ROOT/racc/parser.rb:23
ParseError = Racc::ParseError

# source://RUBY_ROOT/racc/info.rb:16
Racc::Copyright = T.let(T.unsafe(nil), String)

class Racc::Parser
  # source://RUBY_ROOT/racc/parser.rb:281
  def _racc_do_parse_rb(arg, in_debug); end

  # source://RUBY_ROOT/racc/parser.rb:481
  def _racc_do_reduce(arg, act); end

  # common
  #
  # source://RUBY_ROOT/racc/parser.rb:384
  def _racc_evalact(act, arg); end

  # source://RUBY_ROOT/racc/parser.rb:234
  def _racc_init_sysvars; end

  # source://RUBY_ROOT/racc/parser.rb:222
  def _racc_setup; end

  # source://RUBY_ROOT/racc/parser.rb:331
  ...
  #
  # source://RUBY_ROOT/racc/parser.rb:277
  def next_token; end
  ...
  # @raise [ParseError]
  #
  # source://RUBY_ROOT/racc/parser.rb:537
  def on_error(t, val, vstack); end

  # source://RUBY_ROOT/racc/parser.rb:586
  def racc_accept; end

  # source://RUBY_ROOT/racc/parser.rb:591
  def racc_e_pop(state, tstack, vstack); end

  # source://RUBY_ROOT/racc/parser.rb:598
  def racc_next_state(curstate, state); end

  # source://RUBY_ROOT/racc/parser.rb:604
  def racc_print_stacks(t, v); end

  # source://RUBY_ROOT/racc/parser.rb:613
  def racc_print_states(s); end

  # For debugging output
  #
  # source://RUBY_ROOT/racc/parser.rb:560
  def racc_read_token(t, tok, val); end

  # source://RUBY_ROOT/racc/parser.rb:573
  def racc_reduce(toks, sim, tstack, vstack); end

  # source://RUBY_ROOT/racc/parser.rb:567
  def racc_shift(tok, tstack, vstack); end

  # source://RUBY_ROOT/racc/parser.rb:620
  def racc_token2str(tok); end

  # Convert internal ID of token symbol to the string.
  #
  # source://RUBY_ROOT/racc/parser.rb:626
  def token_to_str(t); end

  # Exit parser.
  # Return value is +Symbol_Value_Stack[0]+.
  #
  # source://RUBY_ROOT/racc/parser.rb:550
  def yyaccept; end

  # Leave error recovering mode.
  #
  # source://RUBY_ROOT/racc/parser.rb:555
  def yyerrok; end

  # Enter error recovering mode.
  # This method does not call #on_error.
  #
  # source://RUBY_ROOT/racc/parser.rb:544
  def yyerror; end

  class << self
    # source://RUBY_ROOT/racc/parser.rb:218
    def racc_runtime_type; end
  end
end

# source://RUBY_ROOT/racc/parser.rb:207
...
# source://RUBY_ROOT/racc/parser.rb:209
